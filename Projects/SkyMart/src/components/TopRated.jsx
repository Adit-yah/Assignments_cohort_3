...
const TopRated = () => {
  ...
  return (
    <section className="bg-black min-h-[400px] rounded-[30px] m-4 mb-0 p-8">
      {/* Header */}
      ...
      <div className="space-y-4">
        {loading ? (
          <div className="h-24 rounded-2xl border border-zinc-200 bg-black px-6 flex items-center justify-center">
          ...
          topProducts.map((item) => (
            <div
              key={item.id}
              className="h-24 rounded-2xl border border-zinc-200 bg-black px-6 flex items-center justify-between hover:shadow-md transition"
            >
              ...
              <button className="w-12 h-12 rounded-xl bg-yellow-100 flex items-center justify-center hover:bg-yellow-200 transition">
                <ShoppingBag
                  size={18}

...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div
      ...
      className="group cursor-pointer overflow-hidden rounded-[20px] border border-zinc-700 bg-[#111111] transition-all duration-300 hover:-translate-y-1 hover:border-[#fff700]"
    >
      {/* Image Section */}
      ...
      <div className="space-y-2 p-4">
        ...
        <div className="flex items-center justify-between border-t border-zinc-700 pt-3">
          <span className="text-2xl font-bold text-[#fff700]">
            ${product.price}
          </span>
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-full bg-[#fff700] px-4 py-2 text-sm font-semibold text-black transition hover:bg-yellow-300"
          >

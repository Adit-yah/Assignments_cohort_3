    ...
    <section className="max-w-[1650px] mx-auto px-5 mt-10 mb-16">
      <div className="rounded-[28px] border border-zinc-700 bg-[#111111] p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-[#fff700] font-semibold">
              Your Cart
            </p>
          ...
          <div className="flex flex-col items-start gap-3 rounded-3xl border border-zinc-700 bg-black/30 p-4 text-white md:items-end">
            ...
            <span className="text-3xl font-semibold text-[#fff700]">{cart.length}</span>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-2xl bg-[#fff700] px-5 py-3 text-sm font-semibold text-black transition hover:bg-yellow-300"
              >
                Checkout
              </button>
            </div>
        ...
        {items.length === 0 ? (
          <div className="mt-8 rounded-3xl border border-dashed border-zinc-700 bg-black/30 p-10 text-center text-zinc-400">
            <ShoppingCart size={48} className="mx-auto text-[#fff700]" />
            ...
            <Link
              to="/shop"
              className="mt-6 inline-flex rounded-full bg-[#fff700] px-6 py-3 text-sm font-semibold text-black transition hover:brightness-110"
            >
              Browse products
            </Link>
          </div>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="flex flex-col items-start gap-3 sm:items-end">
                  <span className="text-2xl font-semibold text-[#fff700]">
                  ...
                  <div className="flex items-center gap-2 rounded-2xl border border-zinc-700 bg-zinc-900 px-2 py-1 text-sm text-white">
                    ...
                    <button
                      ...
                      className="h-8 w-8 rounded-xl bg-[#fff700] text-lg font-bold text-black transition hover:bg-yellow-300"
                    >
                      +
                    </button>
                  </div>

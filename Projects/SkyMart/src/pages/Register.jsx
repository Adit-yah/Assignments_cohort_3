    ...
    <div className="min-h-screen bg-[#0b0b0b]  flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="w-full max-w-[440px] bg-[#111111] border border-zinc-800 rounded-[28px] p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full bg-[#1d1d1d] border border-zinc-700 rounded-xl h-10 pl-14 pr-5 text-white placeholder:text-zinc-500 outline-none focus:border-[#fff700]"
            />
          </div>
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full bg-[#1d1d1d] border border-zinc-700 rounded-xl h-10 pl-14 pr-14 text-white placeholder:text-zinc-500 outline-none focus:border-[#fff700]"
            />
          ...
          <button type="submit" className="w-full h-10 rounded-xl bg-[#fff700] text-black font-semibold text-sm flex items-center justify-center gap-2 hover:brightness-110 transition">
            Create Account
            <ArrowRight size={14} />
          </button>
        ...
        <p className="text-center text-zinc-500 mt-7 text-base">
          ...
          <Link to="/login" className="text-[#fff700] font-semibold">
            Sign in
          </Link>
        </p>
      </div>
